                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('presets.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="pedal_brand" class="block mt-1 w-full" type="text" name="pedal_brand" :value="old('pedal_brand')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="pedal_model" class="block mt-1 w-full" type="text" name="pedal_model" :value="old('pedal_model')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="settings" name="settings" rows="6" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" placeholder="Ex: Gain: 7, Treble: 5, Middle: 6, Bass: 4">{{ old('settings') }}</textarea>
